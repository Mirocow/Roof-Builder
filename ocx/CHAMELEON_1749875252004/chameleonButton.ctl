...
Public Property Let PictureSize(ByVal NewPictureSize As Integer)
  On Error GoTo PictureSize_Error
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        m_PictureSize = .ReadProperty("ICONS", 16)
    End With
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    With PropBag
        ...
        Call .WriteProperty("ICONS", m_PictureSize)
    End With
...
'this sub will calculate the rects required to draw the text
    ...
    If Wi = 0 And He = 0 Then Exit Sub
    
    If picSZ.X > 0 And picSZ.Y > 0 Then
    ...
    End Select
    Else
        rc2.Left = 0: rc2.Right = Wi: rc2.Top = 0: rc2.Bottom = He
    End If
...
Private Sub DrawPictures(ByVal State As Byte)
    ...
    If m_PictureSize > 0 Then
        PaintPicture picNormal, picPT.X, picPT.Y, m_PictureSize, m_PictureSize
    Else
...
Private Sub CalcPicSize()
    ...
    If Not picNormal Is Nothing Then
        picSZ.X = m_PictureSize 'UserControl.ScaleX(picNormal.Width, 8, UserControl.ScaleMode)
        picSZ.Y = m_PictureSize 'UserControl.ScaleY(picNormal.Height, 8, UserControl.ScaleMode)
    Else
        picSZ.X = 0: picSZ.Y = 0
    End If
